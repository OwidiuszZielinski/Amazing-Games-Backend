...
INSERT INTO orders(id, "date", status, value, user_id)VALUES(1, '', 1, 1, 1);
INSERT INTO orders(id, "date", status, value, user_id)VALUES(2, '', 1, 1, 2);
INSERT INTO orders(id, "date", status, value, user_id)VALUES(3, '', 1, 1, 3);
INSERT INTO orders(id, "date", status, value, user_id)VALUES(4, '', 1, 1, 4);
